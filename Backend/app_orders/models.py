...
class Orders(models.Model):
    orderId = models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')
    ...
    totalCost = models.DecimalField(default=0, max_digits=12, decimal_places=2, verbose_name='totalCost')
